...
function merkahorro_build_wdr_rule($rule, $separata_exclude_ids = array()) {
    ...
    // IMPORTANTE: FlyCart compara date_from/date_to contra time() de PHP (UTC).
    // WordPress guarda las horas en zona local (Colombia UTC-5).
    // Este código convierte el día/mes del panel a una fecha UTC real
    // para que la regla NO expire 5 horas antes.
    $wdr_date_from = null;
    $wdr_date_to   = null;
